    ...
    <div className="min-h-screen bg-[#0B1120] relative overflow-hidden">
      ...
      <nav className="relative z-20 glass-card rounded-none border-x-0 border-t-0 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="btn-glass text-white text-sm font-medium px-4 py-2 rounded-xl"
            >
              Sign In · دخول
            </Link>
            ...
            <Link
              to="/login?tab=signup"
              className="btn-neon text-white text-sm font-semibold px-4 py-2 rounded-xl"
            >
              Get Started · ابدأ
            </Link>
          </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            to="/login"
            className="border border-gray-600 px-10 py-3 rounded-2xl"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {features.map((f, i) => (
            <GlassCard
              key={i}
              hover
              className="group bg-[#0F1629]/70 backdrop-blur-xl border border-white/5 rounded-2xl p-6 transition-all duration-300 hover:border-cyan-400/40 hover:shadow-[0_0_35px_rgba(34,211,238,0.15)]"
            >
...
bg-gradient-to-br from-blue-500 to-purple-500">
      ...
      <section className="relative z-10 max-w-3xl mx-auto px-6 pb-24 text-center">
        ...
        <GlassCard className="bg-[#0F1629]/70 backdrop-blur-xl border border-white/5 p-10">
          ...
          <Link
            to="/login?tab=signup"
            className="inline-block btn-neon text-white font-bold px-10 py-4 rounded-2xl text-lg"
          >
